  ...
  async getPersonalPatientInfo(): Promise<PersonalPatientInfo> {
    try {
      ...
      const personalInfo: PersonalPatientInfo = {
        ...
        emergency_contact_dial_code: data.emergency_contact_dial_code,
        ...
        emergency_contact_country_code_alt: data.emergency_contact_country_code_alt,
        emergency_contact_dial_code_alt: data.emergency_contact_dial_code_alt,
        emergency_contact_phone_number_alt: data.emergency_contact_phone_number_alt,
